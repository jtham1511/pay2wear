...
import 'package:pay2wear/login/login_widget.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<Pay2wearFirebaseUser> userStream;
  Pay2wearFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = pay2wearFirebaseUserStream()
